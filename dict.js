...
if (dict_args.length) {
    ...
    switch (key) {
        case 'defn':
            ...
            dictionary.defnOrexmple('definitions', word, true);
            break;
        case 'ex':
            if (!word) {
            ...
            dictionary.defnOrexmple('examples', word, true);
            break;
        case 'syn':
            if (!word) {
            ...
            dictionary.synOrant('synonym', word, true);
            break;
        case 'ant':
            if (!word) {
            ...
            dictionary.synOrant('antonym', word, true);
            break;
        default:
